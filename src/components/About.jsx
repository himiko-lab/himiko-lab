  ...
  return (
    <div className="px-6 w-full mx-auto pb-12" id="about">
      <div className="bg-slate-900/80 backdrop-blur-xl border border-white/20 shadow-2xl rounded-[2.5rem] p-10 md:p-14 text-white overflow-hidden relative">
        ...
        {/* Subtle radial gradient blobs inside the card (absolute positioned, behind the text) */}
        ...
        <div className="relative z-10 max-w-3xl">
          <h2 className="text-3xl font-semibold mb-4">About Studio</h2>
          <p className="text-slate-300 text-lg md:text-xl font-light leading-relaxed">
            We believe technology should bring peace of mind, not clutter. Our mission is to develop everyday applications with intuitive designs that seamlessly blend into your life.
          </p>
        </div>
      </div>
    </div>
